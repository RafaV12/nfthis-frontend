  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      <div className="mt-14 md:mt-20 flex flex-col items-center h-auto w-4/5">
        ...
        <Link to={"/create"}>
          <button className="mt-7 mb-4 h-10 w-80 text-white rounded-lg text-center bg-blue-500">
            Create
          </button>
        </Link>

        <Link to={"/settings"}>
          <button className="mb-4 h-10 w-80 border-2 rounded-lg">
            Edit profile
          </button>
        </Link>
        ...
        <div
          ...
          className="p-4 pb-14 flex flex-wrap justify-around items-center w-full"
        >
          {user.nfts.length > 0
            ? user.nfts.map((nft) => (
                <div
