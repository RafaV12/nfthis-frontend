...
const Seller = () => {
  ...
  useEffect(() => {
    if (seller) {
      ...
      const { firstname, lastname, username, nfts, followers, following } =
        seller;
    ...
    <div className="min-h-screen flex justify-center">
      <div className="mt-14 md:mt-20 flex flex-col items-center h-auto w-4/5">
        ...
        <div
          ...
          className="mb-14 flex flex-wrap justify-around items-center w-full"
        >
          {values.nfts.length > 0 ? (
            ...
            <p className="mt-3 text-gray-400">
              {values.username} has not created any NFT yet
            </p>
          )}
        </div>
      </div>
